    ...
    return (
        <Card className="w-full">
            <CardHeader className="border-b border-border/40 pb-6 mb-6">
                <CardTitle className="text-3xl font-bold tracking-tight">Buat Jadwal Baru</CardTitle>
                <CardDescription className="text-base mt-2">
                    Tambahkan jadwal latihan wajib, kelas, atau training camp untuk sistem manajemen taekwondo.
                </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="grid gap-8 md:grid-cols-2">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Tipe Jadwal</label>
                                <Select
                                    value={scheduleType}
                                    onValueChange={(value) => {
                            ...
                            {scheduleType === 'kelas' && (
                                <div className="space-y-2">
                                    <label htmlFor="kelas_id" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                                        Pilih Kelas
                                    </label>
                                    <Select
                                    ...
                                    {errors.kelas_id && (
                                        <p className="mt-1 text-sm text-destructive">{errors.kelas_id}</p>
                                    )}
                                </div>
                            )}
                            ...
                            {scheduleType === 'kelas' && (
                                <div className="flex items-center space-x-2 bg-muted/50 p-3 rounded-lg border border-border/50">
                                    ...
                                    />
                                    <label htmlFor="replacement" className="text-sm font-medium leading-none cursor-pointer">
                            ...
                            {((scheduleType === 'latihan_wajib') ||
                                (scheduleType === 'kelas' && !isReplacement)) && (
                                    <div className="space-y-2">
                                        <label htmlFor="hari" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                                            Hari Pelaksanaan
                                        </label>
                                        <Select
                                            value={formData.hari}
                                        ...
                                        {errors.hari && (
                                            <p className="mt-1 text-sm text-destructive">{errors.hari}</p>
                                        )}
                                    </div>
                                )}
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            {((scheduleType === 'latihan_wajib') ||
                                (scheduleType === 'kelas' && !isReplacement)) && (
                                    <div className="space-y-2">
                                        ...
                                        >
                                            Tanggal Efektif <CalendarIcon className="w-4 h-4 text-muted-foreground" />
                                        </label>
                                        <Input
                                            id="effective_from"
                                            name="effective_from"
                            ...
                            {scheduleType === 'kelas' && isReplacement && (
                                <div className="space-y-2">
                                    <label htmlFor="tanggal" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex items-center gap-2">
                                        Tanggal Kelas Pengganti <CalendarIcon className="w-4 h-4 text-muted-foreground" />
                                    </label>
                                    <Input
                                        id="tanggal"
                                        name="tanggal"
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div className="space-y-2">
                                        <label
                                            ...
                                            className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex items-center gap-2"
                                        >
                                            Tanggal Mulai <CalendarIcon className="w-4 h-4 text-muted-foreground" />
                                        </label>
                                        <Input
                                            id="tanggal_mulai"
                                            name="tanggal_mulai"
                                    ...
                                    <div className="space-y-2">
                                        <label
                                            ...
                                            className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex items-center gap-2"
                                        >
                                            Tanggal Selesai <CalendarIcon className="w-4 h-4 text-muted-foreground" />
                                        </label>
                                        <Input
                                            id="tanggal_selesai"
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div className="space-y-2">
                                    <label htmlFor="jam_mulai" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                                        Jam Mulai
                                    </label>
                                    <Input
                                        id="jam_mulai"
                                    ...
                                    />
                                    {errors.jam_mulai && (
                                        <p className="mt-1 text-sm text-destructive">{errors.jam_mulai}</p>
                                    )}
                                </div>
                                <div className="space-y-2">
                                    <label
                                    ...
                                    />
                                    {errors.jam_selesai && (
                                        <p className="mt-1 text-sm text-destructive">{errors.jam_selesai}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            {/* Location */}
                            <div className="space-y-2">
                                <label htmlFor="lokasi" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex items-center gap-2">
                                ...
                                />
                                {errors.lokasi && (
                                    <p className="mt-1 text-sm text-destructive">{errors.lokasi}</p>
                                )}
                            </div>
                        </div>
                    </div>
