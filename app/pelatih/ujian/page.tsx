...
export default function InputHasilUjianPage() {
  ...
  const fetchUjians = async () => {
    try {
      setRefreshing(true);
      setError(null);
      const response = await fetch("/api/pelatih/ujian/inputable");
      if (!response.ok) {
  ...
  const totalBelumDiinput = ujians.reduce(
    (sum, u) => sum + Number(u.peserta_belum_diinput),
    0,
  );
                ...
                <div className="container max-w-7xl mx-auto px-4 py-6 space-y-6">
                  ...
                  <div className="space-y-2">
                    <h1 className="text-3xl font-bold tracking-tight text-foreground">
                      Input Hasil Ujian Kenaikan Sabuk
                    </h1>
                    <p className="text-muted-foreground">
                      Kelola dan input hasil ujian kenaikan sabuk yang menjadi
                      tanggung jawab Anda.
                    </p>
                  </div>
                        ...
                        <Table>
                          <TableHeader>
                            <TableRow className="bg-muted/50">
                              ...
                              <TableHead>Belum Diinput</TableHead>
                              <TableHead>Batas Input</TableHead>
                                  ...
                                  <div className="flex flex-col items-center gap-2">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-sm text-muted-foreground">
                                        Tidak ada ujian yang dapat diinput hasil
                                        saat ini.
                                      </p>
                                    </div>
                                  </div>
                              ...
                              filteredUjians.map((ujian) => (
                                ...
                                >
                                  ...
                                  <TableCell>
                                    ...
                                    >
                                      {ujian.peserta_belum_diinput} Peserta
                                    </Badge>
                                  </TableCell>
                                  <TableCell>
                                    <Badge
                                    ...
                                    >
                                      {formatDate(ujian.batas_input)}
                                    </Badge>
                                  </TableCell>
                                  <TableCell className="text-right">
                                    <Link href={`/pelatih/ujian/${ujian.id}`}>
                                      <Button
                                        size="sm"
                                        title="Input hasil ujian"
                                      >
                      ...
                      <div className="md:hidden space-y-4">
                        {loading ? (
                          ...
                          <div className="text-center py-12">
                            ...
                            <p className="text-sm text-muted-foreground">
                              Tidak ada ujian yang dapat diinput hasil saat ini.
                            </p>
                          </div>
                        ) : (
                          filteredUjians.map((ujian) => (
                              ...
                              <CardContent className="pt-6 space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-2 pt-2">
                                  ...
                                  <Badge
                                    ...
                                    className="bg-yellow-100 text-yellow-800"
                                  >
                                    {ujian.peserta_belum_diinput} Belum
                                  </Badge>
                                </div>
                                <div>
                                  <p className="text-xs text-muted-foreground">
