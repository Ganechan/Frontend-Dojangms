...
export default function InputHasilUjianPage() {
    ...
    for (const p of changedPeserta) {
      try {
        ...
        const res = await fetch(
          `/api/pelatih/ujian/${ujianId}/peserta/${p.peserta_id}`,
          {
            method: "PUT",
  ...
  const sudahDiinput = pesertaList.filter(
    (p) =>
      p.status !== "terdaftar" ||
      (p.localStatus && p.localStatus !== "terdaftar"),
  ).length;
                ...
                <div className="container max-w-7xl mx-auto px-4 py-6 space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mt-2">
                      Input dan perbarui status kelulusan peserta ujian.
                    </p>
                  </div>
