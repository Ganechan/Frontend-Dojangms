// app\pelatih\editKejuaraan\[id]\page.tsx
"use client";
    ...
    for (const p of changedPeserta) {
      try {
        ...
        const res = await fetch(
          `/api/pelatih/kejuaraan/${kejuaranId}/peserta/${p.peserta_id}/edit`, // <-- URL baru
          {
            method: "PUT", // atau "PATCH" jika diperlukan
              ...
              <div className="min-h-screen bg-background">
                <div className="container max-w-7xl mx-auto px-4 py-6 space-y-6">
                  <div className="flex items-center justify-between">
                    <Link href="/pelatih/editKejuaraan">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mt-2">
                      Edit dan perbarui hasil peserta kejuaraan.
                    </p>
                  </div>
